...
// ============================================
// APLICAR FILTROS Y ORDEN (NUEVA FUNCIÓN UNIFICADA)
// ============================================
...
function renderizarJuegos() {
    ...
    juegosFiltrados.forEach((juego, index) => {
        ...
        // Detectar si es nuevo (últimos 7 días)
        const esNuevo = juego.fecha_anadido && 
            (new Date() - new Date(juego.fecha_anadido) < 7 * 24 * 60 * 60 * 1000);
...
// ============================================
// MODAL - FICHA DETALLADA (CON NAVEGACIÓN)
// ============================================
...
// ============================================
// NAVEGACIÓN ENTRE JUEGOS EN MODAL
// ============================================
...
function importarDatos(event) {
    ...
    // Resetear el input para poder importar el mismo archivo dos veces
    event.target.value = '';
}
...
// ============================================
// ATEJO DE TECLADO (Ctrl+K para búsqueda)
// ============================================
document.addEventListener('keydown', function(e) {
